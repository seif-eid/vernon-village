...
module.exports = function (λ, delay) {
    return function () {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.t0 = resolve;
                                _context.next = 4;
                                return λ.apply(undefined, _arguments);
...
module.exports = function (target, event, λ) {
    if (target.once) {
        target.once(event, λ);
    ...
    var on = target.on || target.addListener || target.addEventListener;
    var off = target.off || target.removeListener || target.removeEventListener;

    var handler = function handler() {
        off.call(target, event, handler);

        λ.apply(undefined, arguments);
    };
...
var loggingFunction = console.error.bind(console);
 ...
 */
module.exports = function (truthy, message) {
    if (!truthy) {
...
module.exports.setErrorLoggingFunction = function (λ) {
    loggingFunction = λ;
};

module.exports.getErrorLoggingFunction = function () {
 ...
 */
module.exports = function (methodName, method) {
    ...
    var recurry = function recurry() {
        ...
        if (parameters.length < staticVersionArity) {
            return function () {
                for (var _len2 = arguments.length, additionalParameters = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
                    additionalParameters[_key2] = arguments[_key2];
                }

                return recurry.apply(undefined, (0, _toConsumableArray3.default)(parameters.concat(additionalParameters)));
            };
        }

        var instance = parameters[staticVersionArity - 1];
...
var delayed = __webpack_require__(30);
 ...
 */
module.exports = function (λ, delay) {
  for (var _len = arguments.length, otherArguments = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
    otherArguments[_key - 2] = arguments[_key];
  }

  return delayed(λ, delay).apply(undefined, otherArguments);
};
...
module.exports = function (Constructor) {
  return function () {
    return new (Function.prototype.bind.apply(Constructor, [null].concat(Array.prototype.slice.call(arguments))))();
  };
};
...
var flow = __webpack_require__(111);
var deburr = __webpack_require__(110);
var toLower = __webpack_require__(113);

var looseMatchTransform = flow(deburr, toLower);
...
module.exports = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(λ, predicate) {
        var value;
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
 ...
 */
module.exports = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(λ, inputArray, defaultReturnValue) {
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        return _context.abrupt("return", inputArray.reduce(function (promise, element, i, collection) {
                            return promise.then(function () {
                                return λ(element, i, collection);
                            });
                        }, _promise2.default.resolve(defaultReturnValue)));
  ...
  return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", λ.apply(undefined, _args));
...
module.exports = function (λ) {
    ...
    var printException = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var crashFunction = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : process.exit.bind(process);
...
module.exports = {
    makeRandomAlphanumericalString: __webpack_require__(58),
    addOneTimeListener: __webpack_require__(49),
    noConcurrentCalls: __webpack_require__(60),
    curriedDemethodify: __webpack_require__(53),
    repeatAsyncUntil: __webpack_require__(62),
    numberOfDecimals: __webpack_require__(61),
    createErrorType: __webpack_require__(52),
    looselyMatches: __webpack_require__(57),
    tryOrCrash: __webpack_require__(65),
    sequentially: __webpack_require__(63),
    demethodify: __webpack_require__(55),
    factorify: __webpack_require__(56),
    methodify: __webpack_require__(59),
    toAsync: __webpack_require__(64),
    delayed: __webpack_require__(30),
    compact: __webpack_require__(51),
    assert: __webpack_require__(50),
    delay: __webpack_require__(54)
};
